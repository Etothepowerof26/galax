-- All credits goto the PAC3 server, source:
-- https://github.com/PAC3-Server/notagain/blob/master/lua/notagain/essential/libraries/netdata.lua
...
-- Quick mapping instead of replacing.
_G.netdata = netdata